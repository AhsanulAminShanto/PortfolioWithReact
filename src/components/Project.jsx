...
function Project() {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: 'Game Project',
      category: 'Games',
      desc: 'Created interactive Unity game levels and logic.',
    ...
    },
    {
      ...
      category: 'Games',
      desc: 'Designed and deployed personal portfolio using Next.js.',
      img: '/images/portfolio7.jpg',
      github: '#',
      live: '#',
    },
    {
      ...
      title: 'Chat App',
      category: 'Games',
      desc: 'Real-time chat application using WebSockets.',
      img: '/images/portfolio9.jpg',
      github: '#',
      live: '#',
    },
    {
