...
const Skills = () => {
    ...
    <section className="services" id="services">
      ...
      <div className="services-container">
        ...
        <div className="services-box">
          ...
          <Link to="/project#Frontend" className="btn">Read More</Link>
        </div>
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/django/django-plain.svg" alt="Django" />
          ...
          <Link to="/project#Backend" className="btn">Read More</Link>
        </div>
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg" alt="VS Code" />
          ...
          <Link to="/project#Cloud" className="btn">Read More</Link>
        </div>
        {/* Problem Solving */}
<div className="services-box">
  ...
  <div className="tech-container">
    <div className="tech-item" data-name="HackerRank">
      <a href="https://www.hackerrank.com/profile/ahsanulaminshan1" target="_blank" rel="noopener noreferrer">
    ...
    <div className="tech-item" data-name="LeetCode">
      <a href="https://leetcode.com/u/ahsanulaminshanto/" target="_blank" rel="noopener noreferrer">
    ...
    <div className="tech-item" data-name="Codeforces">
      <a href="https://codeforces.com/profile/KnightCoderX" target="_blank" rel="noopener noreferrer">
    ...
    <div className="tech-item" data-name="CodeChef">
      <a href="https://www.codechef.com/users/ahsanulshanto" target="_blank" rel="noopener noreferrer">
  ...
  <p>
    Click on the icons to visit my profiles on various competitive programming platforms
  </p>
